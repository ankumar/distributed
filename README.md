...
Expanding the span to Universe across all of the software development driving towards "Public" spaces building Communities, Platforms & ecosystems, a need for **New IDE** (Integrated Developer experience) is a way to adddress the challenges, more data below:
